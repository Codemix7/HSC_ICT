...
public class mcq4 extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_mcq4);
        setTitle("এম সি কিউ চতুর্থ অধ্যায়");
