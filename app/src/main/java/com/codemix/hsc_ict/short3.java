...
public class short3 extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_short3);
        setTitle("সংক্ষিপ্ত প্রশ্ন তৃতীয় অধ্যায়");
