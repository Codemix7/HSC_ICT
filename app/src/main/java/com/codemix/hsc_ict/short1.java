...
public class short1 extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_short1);
        setTitle("সংক্ষিপ্ত প্রশ্ন প্রথম অধ্যায়");
