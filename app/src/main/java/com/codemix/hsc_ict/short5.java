...
public class short5 extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_short5);
        setTitle("সংক্ষিপ্ত প্রশ্ন পঞ্চম অধ্যায়");
